...
public class SendAndReceiver implements SerialPortEventListener {
 ...
 public SendAndReceiver(String portName, boolean mode) {
...
//          Thread.sleep(50);
 ...
 private class SerialWriter implements Runnable {
  ...
  public SerialWriter(String serialData) {
   this.data = sendDataFormat(serialData); //Checksum data 생성
  }
 ...
 public static void main(String args[]) throws IOException {
   ...
   SendAndReceiver ss = new SendAndReceiver("COM8",true);
